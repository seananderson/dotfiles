...
hi Normal       guifg=#5a5a5a guibg=#f5f6f6          ctermfg=black    ctermbg=white
...
hi Comment      guifg=#cccccc guibg=bg               ctermfg=darkblue
...
if version >= 700
  ...
  " Spell
  hi SpellBad  	               gui=undercurl               ctermfg=red 		                   cterm=underline
